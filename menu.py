        ...
        if int(menu_category) in menu_items.keys():
            ...
            if menu_selection.isdigit():
                ...
                if menu_selection in menu_items:
                    ...
                    # Tell the customer that their input isn't valid #Gi#3.1???
                    print(f"{menu_selection} is not a valid menu item number.")
            else:
                # Tell the customer they didn't select a menu option
                print("You didn't select a menu item number.")
        else:
            # Tell the customer they didn't select a menu option
...
#print(order)  # Uncomment to check the structure of the order
